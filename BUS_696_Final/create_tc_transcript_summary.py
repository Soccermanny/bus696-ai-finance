...
videos_dir = Path(r"c:\Users\manny\Documents\BUS696\Chapman_FSM_DCF\Videos\BUS_696_TC")
output_file = videos_dir / "TC_TRANSCRIPTS_SUMMARY.md"
...
md_content = []
md_content.append("# Trading Comps Modeling Video Transcripts - Complete Summary\n")
md_content.append(f"**Date Generated:** {datetime.now().strftime('%B %d, %Y')}\n")
md_content.append(f"**Total Transcripts:** {len(transcripts)}\n")
md_content.append("**Location:** `Chapman_FSM_DCF/Videos/BUS_696_TC/`\n\n")
md_content.append("---\n\n")
...
md_content.append("```\n")
md_content.append("Chapman_FSM_DCF/Videos/BUS_696_TC/{TopicName}/transcript/{TopicName}.transcript.txt\n")
md_content.append("```\n\n")
md_content.append("**Full Windows Path Pattern:**\n")
md_content.append("```\n")
md_content.append("c:\\Users\\manny\\Documents\\BUS696\\Chapman_FSM_DCF\\Videos\\BUS_696_TC\\{TopicName}\\transcript\\{TopicName}.transcript.txt\n")
md_content.append("```\n\n")
md_content.append("---\n\n")
...
for transcript in transcripts:
    ...
    md_content.append(f"**Relative Path:** `Chapman_FSM_DCF/Videos/BUS_696_TC/{topic_name}/transcript/{topic_name}.transcript.txt`\n\n")
