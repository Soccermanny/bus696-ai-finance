...
videos_dir = Path(r"c:\Users\manny\Documents\BUS696\Chapman_FSM_DCF\Videos\BUS_696_MA")
output_file = videos_dir / "MA_TRANSCRIPTS_SUMMARY.md"
...
md_content = []
md_content.append("# Mergers & Acquisitions (M&A) Modeling Video Transcripts - Complete Summary\n")
md_content.append(f"**Date Generated:** {datetime.now().strftime('%B %d, %Y')}\n")
md_content.append(f"**Total Transcripts:** {len(transcripts)}\n")
md_content.append("**Location:** `Chapman_FSM_DCF/Videos/BUS_696_MA/`\n\n")
md_content.append("---\n\n")
...
md_content.append("```\n")
md_content.append("Chapman_FSM_DCF/Videos/BUS_696_MA/{TopicName}/transcript/{TopicName}.transcript.txt\n")
md_content.append("```\n\n")
md_content.append("**Full Windows Path Pattern:**\n")
md_content.append("```\n")
md_content.append("c:\\Users\\manny\\Documents\\BUS696\\Chapman_FSM_DCF\\Videos\\BUS_696_MA\\{TopicName}\\transcript\\{TopicName}.transcript.txt\n")
md_content.append("```\n\n")
md_content.append("---\n\n")
...
for transcript in transcripts:
    ...
    md_content.append(f"**Relative Path:** `Chapman_FSM_DCF/Videos/BUS_696_MA/{topic_name}/transcript/{topic_name}.transcript.txt`\n\n")
